...
namespace Lógica
{
    class PagoL
    {
        ...
        public PagoL(string pId_pago, DateTime pFecha_corte, string pDescripcion, double pTotalPagar, string pCreado_por, DateTime pFecha_creacion, string pModificado_por, DateTime pFecha_modificacion)
        {
        ...
        public string toString() { 
            return("Numero de pago: "+this.id_pago+
