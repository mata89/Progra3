...
namespace Lógica
{
    class UsuarioL
    {
        ...
        public UsuarioL(string pId_usuario,string pTipo_usuario,string pNombre_usuario,string pApellido1_usuario,string pApellido2_usuario,string pContrasenia,string pActivo,string pCreado_por,string pFecha_creacion,string pModificado_por,string pFecha_modificacion) {
